...
function doAction() {
	...
	if(command === 'help' || command === 'HELP' || command === 'Help') {
		...
		outElement.innerHTML = "move [direction](up down left right forward back)<br> look [direction] <br> eat [item] <br> pick up/grab [item] <br> drop[item] <br> inventory (to display inventory) <br> talk to (person) <br> attack (person) with (item[fist]) <br> \"[what is your name? / what are you doing?]\" <br> help"
		setTimeout(function() {
...
game.start = function() {
	inElement.style.display = "none"
	printOut("move [direction](up down left right forward back)<br> look [direction] <br> eat [item] <br> pick up/grab [item] <br> drop[item] <br> inventory (to display inventory) <br> talk to (person) <br> attack (person) with (item[fist]) <br> \"[what is your name? / what are you doing?]\" <br> help")
